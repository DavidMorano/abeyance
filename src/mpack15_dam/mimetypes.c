...
/*******************************************************************************
	...
	This object module manages a MIME-type database.  It reads in
	MIME-type formatted files with the 'mimetypes_file()'
	...
	*must* be a single contiguous string without any white-space in
	it.  This may be obvious but it should be observed when
	creating 'mimetypes' files.  This code does not (currently) try
