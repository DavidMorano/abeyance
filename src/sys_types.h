...
/****
  I am very sorry (ya right) that the following type-def must go
  (get eliminated).  It conflicts with another type-def (that was
  also something of a screw-up) but which is more import right now.
  Deal with it!
****/
...
typedef struct { 
    short sema_owner; short  sema_value; short sema_svalue; 
} sema1_t ;
