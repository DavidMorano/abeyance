...
/*******************************************************************************
	...
	This code was borrowed (salvaged) from the original version
	that came with (I think) the old NetNews-C software. The
	original code has been made a bit more portable but is
	otherwise almost the same as before. for the most part,
	subroutine names have remained the same with the original
	code.
