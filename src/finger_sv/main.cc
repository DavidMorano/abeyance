...
void fwopen();
void initscreening();
void ltimdebugprint(char *before, time_t *dt, char *after);
 ...
 */
void
ltimdebugprint(char *before, time_t *dt, char *after)
{
	register struct tm *delta;
